      ...
      <div className="flex flex-col sm:flex-row items-center">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-700 bg-white p-6 rounded-lg shadow-md">
            Welcome to THE SOS-HUB, your go-to forum for sharing and discussing opinions on a wide range of topics. Our platform is designed to provide a space where everyone can voice their thoughts and engage in meaningful conversations about the world around us.
            ...
            Our mission is to create a vibrant, inclusive, and respectful environment where diverse voices can come together to explore ideas, challenge assumptions, and connect over shared experiences. The longer you explore our forum, the more untold stories and fresh insights you'll discover.
            ...
            Welcome to THE SOS-HUB, where every story matters.
          </p>
        </div>
      </div>
    </div>
