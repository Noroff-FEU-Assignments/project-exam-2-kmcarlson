    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center mt-8">
        <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-md mb-4 sm:mb-0 sm:mr-4">
          <h2 className="text-2xl font-bold mb-2">Info Box 1</h2>
          <p className="text-gray-700">Her er noe informasjon om info boksen 1.</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
          <h2 className="text-2xl font-bold mb-2">Info Box 2</h2>
          <p className="text-gray-700">Her er noe informasjon om info boksen 2.</p>
        </div>
      </div>
    </div>
 );
